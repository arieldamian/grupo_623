package com.kotlindroider.fitsoa
...
class SignupActivity : AppCompatActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.kotlindroider.fitsoa.R.layout.activity_signup)
        ...
        _loginLink!!.setOnClickListener {
            ...
            finish()
            overridePendingTransition(com.kotlindroider.fitsoa.R.anim.push_left_in, com.kotlindroider.fitsoa.R.anim.push_left_out)
        }
    }
    ...
    fun signup() {
        ...
        val progressDialog = ProgressDialog(this@SignupActivity,
                com.kotlindroider.fitsoa.R.style.AppTheme_Dark_Dialog)
